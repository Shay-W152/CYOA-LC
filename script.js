...
const story = {
  ...
  3: {
   ...
   options:[
    { text: "Look Around", next: 2 },  { text: "Look out the porthole", next: 3}, {text: "Head for the Docking Bay", next: 4
  } 
   ]
  },
  4:{
    ...
    options:[
      {text:"Go Back out the door you came in from", next: 24},{text: "Go North", next:5,} , {text:"Go East" , next:6},
      {text:"Go West", next: 7}
    ]
  },
  5:{
    ...
    options:[
      {text:"go to the oxygen/ grav-projector room", next: 6}, {text:"Go to Escape pods/ Engines Room", next: 7} ,{text:"Go back to Docking Bay", next: 4}
    ]
  },
  6:{
    ...
    options:[
      {text:"You know when you're supposed to leave a room, head back to the docking bay", next:4 },{text:"Scan the burn marks", next: 8}
    ]
  },
  7:{ 
  ...
  8: {
    ...
    options:[
      {text:"Investigate the Room Further", next:9}, {text:"Go back to Docking Bay", next: 4} 
    ]
  },
  9: {
    ...
    options:[
      {text:"Go back to Docking Bay", next: 4}, {text:"Go to Escape pods/ Engines Room", next: 7},{text: "Go to Command Deck", next:5} 
    ]
  },
  10:{
  ...
  12:{
    ...
    options:[
      {text: "You approach the motionless limb and tap it with your foot, and wait for a response", next:13}, {text:"Walk to the entrance of the escape pod and look inside", next:14} ,{text:"Go back to Docking Bay", next: 4}
    ]
  },
  13:{
